...
public class ScrumTeam {
    ...
    public  void addTester(Tester tester){
        testersList.add(tester); //add 1 tester in array list testers

    }

    public  void addTesters(Tester[] testers){
        testersList.addAll(Arrays.asList(testers) ); //add Array of  testers in array list testers

    }

    public  void addDeveloper(Developer developer){
        devopsList.add(developer); //add 1 developer in array list testers
    }

    public  void addDevelopers(Developer[] developers){
        devopsList.addAll(Arrays.asList(developers) ); //add array developer in array list testers
    }
